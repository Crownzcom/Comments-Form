...
document
  ...
  .addEventListener('submit', function (e) {
    ...
    const slide_nameInput = document.getElementById('slide_name')
    const commentInput = document.getElementById('comment')

    const data = {
      email: emailInput.value,
      slide_name: slide_nameInput.value,
    ...
    fetch('https://comments-form.crownzcom.workers.dev/', {
      ...
      body: JSON.stringify(data) // Stringify the object to JSON for the request body
    })
